...
| Algorithms | `/algorithms` | textbook quantum algorithms: `qft`, `grover`, `vqe`, `qaoa`, `shor`, `teleport`, `deutsch-jozsa`, `bernstein-vazirani`, `simon`, `phase-estimation`, `amplitude-amplification`, `quantum-walk`, `hamiltonian-simulation` |
